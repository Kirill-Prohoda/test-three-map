(function (factory, window) {
    ...
    L.GridLayer.include({
        ...
        _getTiledPixelBounds : function(center, zoom, tileZoom) {
            let pixelBounds = L.EdgeBuffer.previousMethods.getTiledPixelBounds.call(this, center, zoom, tileZoom);
            ...
            if (edgeBufferTiles > 0) {
                let pixelEdgeBuffer = L.GridLayer.prototype.getTileSize.call(this).multiplyBy(edgeBufferTiles);
